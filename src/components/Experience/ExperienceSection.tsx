  ...
  return (
    <section className="py-6 lg:py-20 md:py-16 sm:py-12 px-4 lg:px-20 md:px-16 sm:px-12 relative w-full">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.6, delay: 0.4 }}
        className="mt-4 lg:mt-10 md:mt-8 sm:mt-6 mb-6 lg:mb-15 md:mb-12 sm:mb-8 text-center flex flex-row items-center justify-center gap-0 w-full"
      >
        <div
          className="inline-flex items-center gap-3 lg:gap-8 md:gap-6 sm:gap-4 px-4 lg:px-8 md:px-6 sm:px-5 py-3 lg:py-6 md:py-5 sm:py-4 rounded-2xl max-w-full"
          style={{
            background: "rgba(139, 69, 19, 0.15)",
            backdropFilter: "blur(10px)",
            boxShadow: "0 8px 32px 0 rgba(205, 133, 63, 0.2)",
        ...
        >
          <div className="text-center">
            <div
              className="text-sm lg:text-3xl md:text-2xl sm:text-xl font-bold text-transparent bg-clip-text"
              style={{
                backgroundImage:
                  "linear-gradient(135deg, #D2691E 0%, #F4A460 100%)",
              }}
            ...
            <div
              className="text-xs lg:text-sm mt-0.5 lg:mt-1 md:mt-1 sm:mt-0"
              style={{ color: "#F5DEB3" }}
            >
              Experience
            </div>
                ...
                >
                  ...
                  >
                    <motion.div
                      whileHover={{ scale: 1.02 }}
                      transition={{ type: "spring", stiffness: 300 }}
                      className="rounded-2xl hover:shadow-2xl transition-all duration-300 p-6 lg:p-8 md:p-7 sm:p-6"
                      style={{
                        background: "rgba(139, 69, 19, 0.15)",
                        backdropFilter: "blur(10px)",
                        boxShadow: "0 8px 32px 0 rgba(205, 133, 63, 0.2)",
